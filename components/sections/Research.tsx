        ...
        <Section id="research">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <a href="https://www.buildersgate.com/" target="_blank" rel="noopener noreferrer" className="text-xs font-medium bg-amber-50 text-amber-600 px-3 py-1.5 rounded-full hover:bg-amber-100 transition-colors inline-flex items-center gap-1">Builders Gate <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg></a>
