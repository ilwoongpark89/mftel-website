            ...
            <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-900 pb-16">
                <div className="container relative mx-auto px-6 z-[10]">
                    <div className="max-w-4xl mx-auto text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-white mb-2 leading-[1.15]">
                            {line1}
                        </h1>
                        <h1 className="text-4xl font-bold tracking-tight mb-2 leading-[1.15] text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-rose-300">
                            {line2a} {line2b}
                        </h1>
                        <h1 className="text-4xl font-bold tracking-tight text-white mb-6 leading-[1.15]">
                            {line3}
                        </h1>
