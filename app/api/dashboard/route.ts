...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        if (section === 'all') {
            ...
            const keys = ["announcements","papers","experiments","todos","conferences","lectures","patents","vacations","schedule","timetable","reports","teams","dailyTargets","philosophy","resources","ideas","analyses","chatPosts","customEmojis","equipmentList","personalMemos","analysisToolList","paperTagList"];
